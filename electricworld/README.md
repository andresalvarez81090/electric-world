...
* `git clone git@github.com:rumblex/angularattack2016-electricworld.git`

* `cd angularattack2016-electricworld`
...
If you receive an error message `"You do not have permission to publish to electricworld.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add kjb14d@my.fsu.edu,tektronix0101@gmail.com,andresalvarez81090@gmail.com`
